  ...
  return (
    <div className="max-w-7xl mx-auto my-5 px-4 min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-[30% 27.5% 38%] gap-8">
        <div className="bg-white rounded-2xl font-bold">
          <div className="text-center text-blue-600 p-5 flex flex-col content-between h-full gap-6">
        ...
        <div className="bg-white rounded-2xl p-2">teste</div>
      </div>
